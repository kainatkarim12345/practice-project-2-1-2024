                                                    ...
                                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        ...
                                                        <div class="d-flex justify-content-between flex-lg-wrap">
                                                            @if($key->discount)
                                                                ...
                                                                @endphp
                                                            <p class="text-dark fs-5 fw-bold mb-0" style="text-decoration-line: line-through;">${{$key->price}} </p>
                                                            <p class="text-dark fs-5 fw-bold mb-0" >${{$afterDiscount}} </p>
                                                            @else
                                                                <p class="text-dark fs-5 fw-bold mb-0">${{$key->price}} </p>
                                                            @endif
